    ...
    <View style={styles.container}>
      ...
      <View style={styles.safeArea}>
        ...
        >
          ...
          {/* Filter Chips */}
          <Animated.View entering={FadeInDown.delay(200).duration(400)} style={styles.filterScrollContainer}>
            <ScrollView
              horizontal
          ...
          <Animated.View entering={FadeInDown.delay(260).duration(400)} style={styles.sectionHeader}>
          ...
          {filteredMatches.length > 0 ? (
            filteredMatches.map((match, idx) => {
              const rc = getResultColor(match.result);
              const tb = getMatchTypeBadge(match.matchType);
              return (
                <Animated.View key={match.id} entering={FadeInDown.delay(300 + idx * 60).duration(400)}>
                  <TouchableOpacity
                    activeOpacity={0.9}
                    style={[styles.matchCard, { borderLeftColor: rc.border }]}
                  ...
                  >
                    ...
                    <View style={styles.matchTop}>
                      <View style={{ flex: 1 }}>
                        ...
                        <Text style={styles.matchDate}>{match.date} • {match.ground}</Text>
                      </View>
                      <View style={[styles.matchTypeBadge, { backgroundColor: tb.bg }]}>
                        <Text style={[styles.matchTypeTxt, { color: tb.text }]}>{match.matchType}</Text>
                      </View>
                    </View>
                    ...
                    <View style={styles.vsRow}>
                      ...
                      <View style={styles.vsTeamCol}>
                        <View style={[styles.teamLogo, { backgroundColor: '#F0F4EC' }]}>
                          <Text style={styles.teamLogoTxt}>{match.myTeam.slice(0, 2).toUpperCase()}</Text>
                        </View>
                        <Text style={styles.teamName} numberOfLines={1}>{match.myTeam}</Text>
                      </View>

                      {/* Middle Scores */}
                      <View style={styles.vsScoreCol}>
                        <Text style={styles.vsText}>VS</Text>
                        <Text style={styles.scoreTextA}>{match.myScore}</Text>
                        <Text style={styles.vsSmall}>vs</Text>
                        <Text style={styles.scoreTextB}>{match.oppScore}</Text>
                      </View>

                      {/* Opp Team */}
                      <View style={styles.vsTeamCol}>
                        <View style={[styles.teamLogo, { backgroundColor: '#FFF0F0' }]}>
                          <Text style={[styles.teamLogoTxt, { color: '#FF4D4D' }]}>{match.oppTeam.slice(0, 2).toUpperCase()}</Text>
                        </View>
                        <Text style={styles.teamName} numberOfLines={1}>{match.oppTeam}</Text>
                      </View>

                      {/* Result Badge */}
                      <View style={[styles.resultBadge, { backgroundColor: rc.bg, borderColor: rc.border }]}>
                        <Text style={[styles.resultTxt, { color: rc.text }]}>{match.result}</Text>
                      </View>
                    </View>
                    ...
                    <View style={styles.matchBottom}>
                      <View style={styles.matchMeta}>
                        ...
                        <Text style={styles.metaTxt}>{match.overs} Ov</Text>
                      </View>
                      <View style={styles.matchMeta}>
                        <Feather name="star" size={12} color="#E3A85B" />
                        <Text style={styles.metaTxt}>{match.potm}</Text>
                      </View>
                      <View style={styles.matchMeta}>
                        <Feather name="map-pin" size={12} color="#8A8A8A" />
                        <Text style={styles.metaTxt} numberOfLines={1}>{match.venue}</Text>
                      </View>
                      <View style={styles.chevronBtn}>
                        <Feather name="chevron-right" size={14} color="#A8CD55" />
                      </View>
                    </View>
                  </TouchableOpacity>
                </Animated.View>
            ...
            <View style={styles.emptyContainer}>
              <Feather name="folder-minus" size={32} color="#8A8A8A" style={{ marginBottom: 8 }} />
              <Text style={styles.emptyText}>No matches found matching this filter.</Text>
            </View>
          )}
